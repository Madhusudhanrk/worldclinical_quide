    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1400px;height:500px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1400px;height:500px;overflow:hidden;">
            <div>
                <img data-u="image" src="assets/img/ban1.jpg" />
            </div>
            <div>
                <img data-u="image" src="assets/img/ban2.jpg" />
            </div>
            <div>
                <img data-u="image" src="assets/img/ban3.jpg" />
            </div>
            <div>
                <img data-u="image" src="assets/img/ban4.jpg" />
            </div>
            <div>
                <img data-u="image" src="assets/img/ban5.jpg" />
            </div>
            <div>
                <img data-u="image" src="assets/img/ban6.jpg" />
            </div>
